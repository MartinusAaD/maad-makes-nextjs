                  ...
                  {variantProducts.map((variant) => {
                    ...
                    return (
                      <Link
                        ...
                        className={`flex flex-col gap-1 p-2 border-2 rounded bg-white no-underline transition-all cursor-pointer w-[120px] hover:border-primary hover:-translate-y-0.5 hover:shadow-md ${isActive ? "border-primary" : "border-bg-grey"}`}
                      >
                        {variantImage ? (
                          <img
